        ...
        <div class="container-fluid">
			...
			<div class="row">
				...
				<div class='col-md-12'>
					...
					<button onclick="window.location='receive-voucher-detail-print?salt=<?php echo $_GET['salt'];?>'" class="btn btn-primary pull-right"><i class='fa fa-print'></i> Print this document</button>
