...
if(isset($_POST['remove_supplier']))
	{
		$remove_supplier = trim($_POST['remove_supplier']);
		if(!empty($remove_supplier))
		{
			mysql_query("delete from supplier where id={$remove_supplier}");
			$msgbox = "<div class='alert alert-success'>
			<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
			<strong><i class='fa fa-check-circle'></i> Success!</strong> Supplier Removed
			</div>";
		}
	}
?>
...
<?php echo $static->sidebar("inv-purchase-supplier");?>
...
<section id="min-wrapper">
    <div id="main-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <!--Top header start-->
                    <h3 class="ls-top-header"><i class='fa fa-codepen'></i> Inventory <i class="fa fa-angle-double-right"></i> Supplier</h3>
                    <!--Top header end -->
            ...
            <!-- Main Content Element  Start-->
					  ...
					  <div class="row">
					  <div data-toggle="modal" data-target="#add_supplier" class="col-md-3 col-sm-6">
                            <div class="ls-wizard label-red margin-top-iPad-15">
                                <h2>Supplier <small>(<?php echo $member->total_supplier($_SESSION['clerk']['id']);?>) Total</small></h2>
                                <span style="font-size:23px;">Add Supplier</span>
                                <div class="icon">
					...
					<?php
                     ...
                     <?php 
								if(isset($val_company)){
									$q = mysql_query("select * from supplier where company='{$val_company['id']}' and created_by='{$_SESSION['clerk']['id']}' order by id DESC");
									$prefix = $val_company['prefix'];
								}else{
									$q = mysql_query("select * from supplier where company='{$arr[0]['id']}' and created_by='{$_SESSION['clerk']['id']}' order by id DESC");
									$prefix = $arr[0]['prefix'];
								}
										...
										<div class="col-md-12">											
											<div class="panel panel-default">
												<div class="panel-heading">
													<h3 class="panel-title"><i class='fa fa-cog'></i> Supplier</h3>
												</div>
																...
																<?php 
																	...
																	while($result = mysql_fetch_assoc($q)){
																		...
																		<tr>
																			...
																			<td class='text-center'><a href='supplier-detail?salt=<?php echo $result['salt'];?>'><?php echo ucwords($result['name']); ?></td>
																			...
																			<td class="text-center"><?php echo $result['supplier_company'];?></td>
																			<td class="text-center"><?php echo $result['remarks'];?></td>
																			<td class='text-center'><button onclick="clip_value('remove_supplier','<?php echo $result['id'];?>')" data-toggle="modal" data-target="#dell_supplier" class="btn btn-danger btn-sm"><i class='fa fa-times-circle'></i> Remove</button></td>
																		</tr>
																		<?php
                    ...
                    <div class='row'>
									<span id="supplier_notify"></span>
										<div class='col-md-12'>
													...
													<div class="form-group">
														<label>Company</label>
														<input id="supplier_company" class="form-control" placeholder="Enter Company"/>
													</div>
													<div class="form-group">
														<label>Remarks</label>
													...
													<div class="form-group">
														...
														<button onclick="create_supplier()" class="btn btn-primary full-width">Create Supplier</button>
													</div>
										</div>
	...
	<div class="modal fade" id="dell_supplier" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-dialog modal-lg">
			<div class="modal-content">
				<div class="modal-header label-primary white">
					<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				...
				<div class="modal-body">
					<div class="block">
						<span class="text-danger">
							<p><h4>Are you sure you want to remove this Supplier ?</h4></p>
							<p>Deleting this Supplier will result in the following effects :</p>
							<ul>
								<li>Loss of Data added against this Supplier.</li>
								<li>Loss of Stock added against this Supplier.</li>
							</ul>
				...
				<div class="modal-footer">
					<form method="POST">
						<button type="submit" id="remove_supplier" name="remove_supplier" type="button" class="btn btn-success btn-xs">Remove (???) </button>
