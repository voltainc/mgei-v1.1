...
if(isset($_POST['remove_receive_voucher']))
	{
		$remove_receive_voucher = trim($_POST['remove_receive_voucher']);
		if(!empty($remove_receive_voucher)){
			mysql_query("delete from receive_voucher where id={$remove_receive_voucher}");
			$msgbox = "<div class='alert alert-success'>
			<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>×</button>
			<strong><i class='fa fa-check-circle'></i> Success!</strong> Receive Voucher Removed
			</div>";
			}
	}
?>
...
<?php echo $static->sidebar("receive-voucher");?>
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <h3 class="ls-top-header"><i class='fa fa-ticket'></i> Voucher <i class="fa fa-angle-double-right"></i> Receive Voucher</h3>
					...
					<?php
                     ...
                     <?php 
								...
								if(isset($val_company)){
									...
									$q = mysql_query("select * from receive_voucher where company='{$val_company['id']}' and created_by='{$_SESSION['clerk']['id']}' order by id DESC");

									$prefix = $val_company['prefix'];

								}else{

									$q = mysql_query("select * from receive_voucher where company='{$arr[0]['id']}' and created_by='{$_SESSION['clerk']['id']}' order by id DESC");
													...
													<div class="table-responsive ls-table">
														...
														<table id="datatable" class="table table-bordered">
															...
															<tr>
																...
																<th class='text-center'><b>RV No.</b></th>
																...
																<?php 
																	...
																	while($result = mysql_fetch_assoc($q)){
																		...
																		<tr>
																			...
																			<td class='text-center'><a href='receive-voucher-detail?salt=<?php echo $result['salt'];?>'><?php echo $result['rv_number']; ?></td>
																			...
																			<td class="text-center"><?php echo ucwords($result['issue_from']);?></td>
																			...
																			<td class="text-center"><?php echo ucwords($result['description']);?></td>
																			<td class='text-center'><button onclick="clip_value('remove_receive_voucher','<?php echo $result['id'];?>')" data-toggle="modal" data-target="#dell_receive_voucher" class="btn btn-danger btn-sm"><i class='fa fa-times-circle'></i> Remove</button></td>
																		</tr>
...
<div class="modal fade" id="add_voucher" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
									...
									<span id="voucher_create_msgbox"></span>
										...
										<div class='col-md-12'>
											...
											<div class="form-group">
												...
												<select onchange="receive_method()" id="receive_method" class="form-control">
	...
	<div class="modal fade" id="dell_receive_voucher" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog modal-lg">
				<div class="modal-content">
					<div class="modal-header label-primary white">
						<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
						<h4 class="modal-title" >Remove Receive Voucher (???)</h4>
					</div>
					<div class="modal-body">
						<div class="block">
							<span class="text-danger">
								<p><h4>Are you sure you want to remove this Receive Voucher ?</h4></p>
								<p>Deleting this Receive Voucher will result in the following effects :</p>
								<ul>
									<li>Loss of Data added against this Receive Voucher.</li>
								</ul>
					...
					<div class="modal-footer">
						<form method="POST"><button type="submit" id="remove_receive_voucher" name="remove_receive_voucher" type="button" class="btn btn-success btn-xs">Remove (???) </button>
