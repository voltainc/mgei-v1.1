...
<?php echo $static->sidebar("rep-sale-return");?>
        ...
        <div class="container-fluid">
            ...
            <!-- Main Content Element  Start-->
					...
					<div class="col-md-1">
						<div class="form-group">
							<label>Action</label>
							<a href="javascript:void(0)" class="btn ls-light-blue-btn btn-round" onclick=retrieve({'act':'fetch_report_sale_return'})>Submit</a>
						</div>
					</div>
					</div>
