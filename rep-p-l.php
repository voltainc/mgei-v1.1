...
<?php echo $static->sidebar("rep-p-l");?>
    ...
    <div id="main-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <!--Top header start-->
                    <h3 class="ls-top-header"><i class='fa fa-codepen'></i> Report <i class="fa fa-angle-double-right"></i> Profit / Loss(Factory)</h3>
                    <!--Top header end -->
            ...
            <!-- Main Content Element  Start-->
					...
					<div class="col-md-1">
						<div class="form-group">
							<label>Action</label>
							<a href="javascript:void(0)" class="btn ls-light-blue-btn btn-round" onclick=retrieve({'act':'fetch_report_sale_p_l'})>Submit</a>
						</div>
					</div>
					</div>
