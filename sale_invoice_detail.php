...
$invdtls = $member->retrieve(['act'=>'sale_invoice_details','inv'=>trim($_REQUEST['inv']),'type'=>'credit']);
...
if($invdtls['order']==null){
	...
	$payload_order = array
		...
		$member->crud(array("act"=>"insert","table"=>"sale_inv_order","fields"=>$payload_order));
		$status_remarks = true;
}else{
...
if(isset($_POST['upload'])){
	...
	$status = ($member->upload($_FILES['document'],"uploads/invoice/sale/credit",$invdtls['invoice_detail']['id']));
        ...
        <div class="container-fluid">
            <div class="row" id="noprint">
                <div class="col-md-12" id="noprint">
                    <!--Top header start-->
                    <h3 class="ls-top-header" id="noprint">Credit Sale Details</h3>
                    <!--Top header end -->
											...
											<div class="panel panel-default">
												<div class="panel-heading">
													<h3 class="panel-title">Item
														...
														<div class="ls-button-group demo-btn pull-right">
															<a href='sale_invoice_detail_print?type=credit&inv=<?php echo $_REQUEST['inv'];?>' class="btn btn-xs btn-primary"><i class="fa fa-print"></i></a>
														</div>
												...
												<div class="panel-body">
													...
													<div class="table-responsive ls-table">
														<table class="table">
															...
															<tbody>
																<?php
																	$q = mysql_query("select * from sale_item_returned where inv='{$invdtls['invoice_detail']['id']}'");
																	...
																	?>
																		<tr>
																			...
																			<td><?php echo $result['remarks'] ? $result['remarks'] : "-"; ?></td>
										...
										<div class="col-md-12">
                                            ...
                                            <ul class="ls-feed">
                                                <?php 
													...
													$docs = @$member->dirToArray("uploads/invoice/sale/credit/{$invdtls['invoice_detail']['id']}");
													if(!empty($docs))
													{
														foreach($docs as $val)
														{
												?>
														<li> 
															...
															<a href="javascript:void(0)" onclick="OpenInNewTab('<?php echo "uploads/invoice/sale/credit/{$invdtls['invoice_detail']['id']}/{$val}";?>')"><?php echo $val; ?></a>
															<a title='Remove (نزع)' class="text-danger" href="javascript:void(0)" data-toggle="modal" data-target="#unlink" onclick="clip_value('remove_document','<?php echo "uploads/invoice/sale/credit/{$invdtls['invoice_detail']['id']}/{$val}";?>')"><span class="date"><i class='fa fa-times-circle'></i></span></a>
														</li>
												<?php 
														}
													}else{
