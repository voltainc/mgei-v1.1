...
$obj = new main();
$obj->check_sesh("clerk-wh",array("pass"=>"dashboard-wh","fail"=>NULL));
$obj->connect_db();
$member = new member();
if(isset($_POST['login']))
	{
		$val = $member->verify_login($_POST['username'],$_POST['password'],"clerk-wh");
		
			if($val['status']=='success'){
				$obj->create_sesh(array("sesh"=>"clerk-wh","value"=>$val['message']),"dashboard-wh");
			}else{
...
<section>
                    ...
                    <div class="login-form">
                        <form action="" method="POST">
                            ...
                            <div class="input-group ls-group-input login-btn-box">
                                ...
                                <a class="" href="../"><i class="fa fa-arrow-circle-o-left"></i> FACTORY</a>
                            </div>
                        </form>
                    </div>
    ...
    <p class="copy-right big-screen hidden-xs hidden-sm">
        <span>&#169;</span> ACC <span class="footer-year"><?php echo date("Y");?></span>
    </p>
</section>
