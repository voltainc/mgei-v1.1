...
$invdtls = $member->retrieve(['act'=>'sale_invoice_details_wh','inv'=>trim($_REQUEST['inv']),'type'=>'credit']);
...
if(isset($_POST['upload'])){
	...
	$status = ($member->upload($_FILES['document'],"uploads/invoice-wh/sale/credit",$invdtls['invoice_detail']['id']));
						...
						<div class="modal-body with-padding">
							<div class="panel panel-success">
								<div class="panel-heading">
									<h6 class="panel-title">Sale Invoice</h6>
												...
												<div class="panel-heading">
													<h3 class="panel-title">Item
														...
														<div class="ls-button-group demo-btn pull-right">
															<a href='sale_invoice_detail_print-wh?type=credit&inv=<?php echo $_REQUEST['inv'];?>' class="btn btn-xs btn-primary"><i class="fa fa-print"></i></a>
														</div>
										...
										<div class="col-md-12">
                                            ...
                                            <ul class="ls-feed">
                                                <?php 
													...
													$docs = @$member->dirToArray("uploads/invoice-wh/sale/credit/{$invdtls['invoice_detail']['id']}");
													if(!empty($docs))
													{
														foreach($docs as $val)
														{
												?>
														<li> 
															...
															<a href="javascript:void(0)" onclick="OpenInNewTab('<?php echo "uploads/invoice-wh/sale/credit/{$invdtls['invoice_detail']['id']}/{$val}";?>')"><?php echo $val; ?></a>
															<a title='Remove (نزع)' class="text-danger" href="javascript:void(0)" data-toggle="modal" data-target="#unlink" onclick="clip_value('remove_document','<?php echo "uploads/invoice-wh/sale/credit/{$invdtls['invoice_detail']['id']}/{$val}";?>')"><span class="date"><i class='fa fa-times-circle'></i></span></a>
														</li>
												<?php 
														}
													}else{
