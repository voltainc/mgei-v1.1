...
<?php echo $static->nav("inner"); ?>
	...
	<?php echo $static->sidebar("invc-sale");?>
					 ...
					 ?>
						...
						<div class="col-md-3">
						  ...
						  isset($val_company) ? $comp = $val_company : $comp = $arr[0];
								...
								$q = mysql_query("select * from sale_invoice where company = {$comp['id']} AND created_by='{$_SESSION['clerk']['id']}' and type='credit'");
								if(mysql_num_rows($q)>0)
								{
								?>
									<div class="row">
															...
															<tbody>
																...
																<?php 
																	...
																	while($result = mysql_fetch_assoc($q)){
																		...
																		?>
																		<tr>
																			<td class='text-center'><a href="sale_invoice_detail?inv=<?php echo $result['id']; ?>"><?php echo str_pad($result['id'], 8, '0', STR_PAD_LEFT);?></a></td>
