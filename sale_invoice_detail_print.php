	...
	<?php
		...
		foreach($invdtls['sale_item'] as $val)
		{
			...
			if(is_float($amt)){
				...
				isset($arr[1]) ? $arr = ['ro'=>$arr[0],'bz'=>$arr[1]] : $arr = ['ro'=>$arr[0],'bz'=>"000"];
		...
		?>
			<tr>
				...
				<td style="border-left: 1px solid #000000; border-right: 1px solid #000000; border-bottom: 1px solid #000000" align="center" valign="bottom" bgcolor="#F2F2F2" sdval="230" sdnum="1033;0;_(* #,##0.00_);_(* \(#,##0.00\);_(* &quot;-&quot;??_);_(@_)"><?php echo $val['quantity']." ".$val['grouping']; ?></td>
