...
<?php echo $static->nav("inner"); ?>
	...
	<?php echo $static->sidebar("invc-purchase");?>
					 ...
					 ?>
                            ...
                            <div class="panel panel-default">
								...
								<div class="col-md-12 row">
									<div class="col-md-11">
										<div class="form-group">
											<?php 
												$member->retrieve(['act'=>'item_purchase','company'=>(isset($val_company) ? $val_company['id'] : $arr[0]['id'])]);
											?>
									...
									<div class="col-md-1">
										<div class="form-group">
											<button class='btn btn-primary pur_trig' onclick=retrieve({'act':'add_list_purchase'})>Add</button>
										</div>
									</div>
								</div>
						...
						<div class="col-md-3">
                            <div class="panel panel-default">
								...
								<select class='form-control' id="discount_type" onchange=retrieve({'act':'purchase_reset'})>
								...
								<input type='number' placeholder='Discount %' class='form-control pur_trig' id="discount"/>
								</div>
								...
								<div class="form-group">
								<label>Paid</label>
								<input type='number' placeholder='Paid' id="paid" class='form-control pur_trig' />
								</div>
								<div class="form-group">
						  ...
						  isset($val_company) ? $comp = $val_company : $comp = $arr[0];
								...
								$q = mysql_query("select * from purchase_invoice where company = {$comp['id']} AND created_by='{$_SESSION['clerk']['id']}'");
								if(mysql_num_rows($q)>0)
								{
								?>
									<div class="row">
